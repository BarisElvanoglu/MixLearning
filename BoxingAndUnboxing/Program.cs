...
//•	Boxing: Değer tipi(int, struct vb.) bir reference tipe (object veya bir interface) kopyalanıp heap'e konulduğunda oluşan işlem. Bu işlem yeni bir nesne oluşturur ve kopyalama maliyeti taşır.
